package com.feiting.feiapi.interfaceplatform.documentation.controller;
...
public class InterfaceDocController {
     ...
     */
    @Resource
    private InterfaceDocCommandService interfaceDocCommandService;
    ...
    public BaseResponse<InterfaceDocDetailVO> getInterfaceDoc(@NotNull(message = "接口 ID 不能为空")
        ...
        InterfaceDocDetailVO detailVO = interfaceDocQueryService.getDocDetail(
                interfaceInfoId, isCurrentUserAdmin(request));
    ...
    public BaseResponse<Boolean> saveInterfaceDoc(@Valid @RequestBody InterfaceDocSaveRequest saveRequest) {
        return ResultUtils.success(interfaceDocCommandService.saveDoc(saveRequest));
    }
